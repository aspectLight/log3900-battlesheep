...
import 'waiting_room_confirm_unlock_notification_view_model.dart';

class WaitingRoomConfirmUnlockNotificationWidget extends StatelessWidget {
  WaitingRoomConfirmUnlockNotificationWidget({
    super.key,
    required WaitingRoomConfirmUnlockNotificationIntent intent,
    required VoidCallback onDismiss,
  }) : _viewModel = WaitingRoomConfirmUnlockNotificationViewModel(
         intent: intent,
         onDismiss: onDismiss,
       );

  final WaitingRoomConfirmUnlockNotificationViewModel _viewModel;
  ...
  Widget build(BuildContext context) {
    ...
    return _ConfirmationShell(
      message: l10n.confirmUnlockRoom,
