    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildHeaderCell(l10n.result),
          _buildHeaderCell(l10n.abandoned),
        ],
      ),
    );
  }
...
class _GameHistoryRow extends StatelessWidget {
  ...
  const _GameHistoryRow({required this.item, required this.isLast});

  Color get _resultColor => switch (item.result) {
    GameResult.won => const Color(0xFFc9ffe4),
    GameResult.lost => const Color(0xFFfb8585),
    GameResult.abandoned => const Color(0xFFffd68a),
  };

  String get _resultLabel => switch (item.result) {
    GameResult.won => 'Gagnée',
    GameResult.lost => 'Perdue',
    GameResult.abandoned => 'Abandonnée',
  };

  String get _modeLabel => switch (item.mode) {
    GameMode.classique => 'Classique',
    GameMode.ctf => 'CTF',
  };
