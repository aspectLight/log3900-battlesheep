...
import '../auth_validation_errors/auth_validation_errors.dart';
import '../password_text_field/password_text_field.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Watch(
          (context) =>
              AuthValidationErrors(errors: viewModel.usernameErrors.value),
        ),
        ...
        Watch(
          (context) =>
              AuthValidationErrors(errors: viewModel.emailErrors.value),
        ),
        const SizedBox(height: 12),
        ...
        Watch(
          (context) =>
              AuthValidationErrors(errors: viewModel.passwordErrors.value),
        ),
        const SizedBox(height: 12),
