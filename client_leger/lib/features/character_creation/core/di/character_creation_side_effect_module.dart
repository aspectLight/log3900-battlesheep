...
import '../../data/side_effects/character_creation_game_started_notification_side_effect.dart';
...
void registerCharacterCreationSideEffects(GetIt scope, GetIt rootGetIt) {
  ...
  scope.registerSingleton<CharacterCreationGameStartedNotificationSideEffect>(
