...
import 'character_creation_room_locked_notification_view_model.dart';

class CharacterCreationRoomLockedNotificationWidget extends StatelessWidget {
  CharacterCreationRoomLockedNotificationWidget({
    super.key,
    required CharacterCreationRoomLockedNotificationIntent intent,
    required VoidCallback onDismiss,
  }) : _viewModel = CharacterCreationRoomLockedNotificationViewModel(
         intent: intent,
         onDismiss: onDismiss,
       );

  final CharacterCreationRoomLockedNotificationViewModel _viewModel;
        ...
        child: ConstrainedBox(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  l10n.selectedGameHiddenOrDeleted,
