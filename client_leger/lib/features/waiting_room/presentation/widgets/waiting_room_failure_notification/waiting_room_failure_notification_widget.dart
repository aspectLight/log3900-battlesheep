...
import 'waiting_room_failure_notification_view_model.dart';

class WaitingRoomFailureNotificationWidget extends StatelessWidget {
  WaitingRoomFailureNotificationWidget({
    super.key,
    required WaitingRoomFailureNotificationIntent intent,
    required VoidCallback onDismiss,
  }) : _viewModel = WaitingRoomFailureNotificationViewModel(
         intent: intent,
         onDismiss: onDismiss,
       );

  final WaitingRoomFailureNotificationViewModel _viewModel;
