...
import 'waiting_room_confirm_leave_notification_view_model.dart';

class WaitingRoomConfirmLeaveNotificationWidget extends StatelessWidget {
  WaitingRoomConfirmLeaveNotificationWidget({
    super.key,
    required WaitingRoomConfirmLeaveNotificationIntent intent,
    required VoidCallback onDismiss,
  }) : _viewModel = WaitingRoomConfirmLeaveNotificationViewModel(
         intent: intent,
         onDismiss: onDismiss,
       );

  final WaitingRoomConfirmLeaveNotificationViewModel _viewModel;
