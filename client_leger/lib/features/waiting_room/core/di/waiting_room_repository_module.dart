...
void registerWaitingRoomRepositories(
  ...
  final initialRoomState = switch (entryData) {
    WaitingRoomHostEntryData(:final entryFee, :final friendsOnly) =>
      baseRoom.copyWith(entryFee: entryFee, friendsOnly: friendsOnly),
    _ => baseRoom,
  };
