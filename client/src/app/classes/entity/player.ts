...
import { Orientation, PlayerState, Stats } from '@app/interfaces/player.types';
import { StatInfo } from '@app/interfaces/stat-info.interface';

export { Orientation, PlayerState, Stats };
...
export class Player extends Entity {
    ...
    static fromObject(obj: Player): Player {
        ...
        player.activeBanner = obj.activeBanner;
