...
describe('RoomSocketService', () => {
    ...
    describe('Avatar management', () => {
        ...
        it('should return early from reserveAvatar when room has no organisatorId', () => {
            (mockWaitingRoomService.currentRoom.getValue as jasmine.Spy).and.returnValue({ organisatorId: null });
        ...
        it('should throw an error if socket ID is undefined', () => {
            ...
            expect(() => service.reserveAvatar('123', 'avatar1', 'player1')).toThrowError(ErrorMessages.SocketIdNotDefined);
        });
