...
import { AttackResult, CombatPayload, CombatRoom, FlightResult } from '@app/interfaces/payload.interface';
...
describe('ActionSocketService', () => {
    ...
    describe('Socket event handlers', () => {
        ...
        it('should handle EndCombat event when socket ID matches organizer ID and loser is a virtual player', () => {
            ...
            // Set up the socket id to match the hostId
            socketIdValue = hostId;
            ...
            // Set up the room to have the virtual player and the correct hostId
            Object.defineProperty(mockGameManagerService.room, 'players', {
