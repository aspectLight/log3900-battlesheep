...
describe('SocketService', () => {
    ...
    it('should handle virtual player turn when the current player is the host and the next player is virtual', () => {
        ...
        // Set up the room with the current player as the host
        mockGameManagerService.room = {
            roomId: 'testRoomId',
            hostId: 'testSocketId', // Current player is the host
            isDebugging: false,
    ...
    it('should listen to organizatorChanged and update hostId', () => {
        ...
        // Set initial hostId value
        mockGameManagerService.room.hostId = 'oldhostId';

        // Trigger the organizatorChanged event
        eventCallback({ newhostId });

        // Verify that hostId was updated with the new value
        expect(mockGameManagerService.room.hostId).toBe(newhostId);
    });
    ...
    it('should call finishGame when a virtual player wins and current player is the organizer', () => {
        ...
        mockGameManagerService.room.hostId = 'testSocketId';
