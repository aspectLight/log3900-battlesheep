import {
    ...
    WALL_TYPE_TILES,
} from '@app/modules/game/constants/game-validation.constants';
import { ITEM_TYPES } from '@app/shared/constants/item.constants';
...
import { GameValidationResult } from '@app/modules/game/interfaces/game-validation-result';
...
export class GameValidationService {
    ...
    validateItems(board: Board, isCTF: boolean): GameValidationResult {
        ...
        if (isCTF) {
            ...
            const expectedWithFlag = requiredItemsCount + 1;
            if (itemsCount === expectedWithFlag) {
                return { isValid: true };
            }
